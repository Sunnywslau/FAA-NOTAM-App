        ...
        for item in features:
            ...
            if is_match:
                filtered_list.append({
                    "id": notam_info.get('number'),
                    "location": notam_info.get('location'),
                    "start": notam_info.get('effectiveStart'),
                    "end": notam_info.get('effectiveEnd'),
                    "text": raw_text,
                    "full_icao": formatted,
                    "status": notam_info.get('status', 'Active'),
                    "keyword": notam_info.get('qCode', 'N/A') # Just using qCode as keyword proxy if needed
                })
